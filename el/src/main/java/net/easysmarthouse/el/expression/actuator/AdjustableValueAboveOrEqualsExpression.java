 ...
 * @author rusakovich
 */
public class AdjustableValueAboveOrEqualsExpression extends AdjustableValueExpression {

    public AdjustableValueAboveOrEqualsExpression(EvaluationContext context) {
        super(context);
    }
