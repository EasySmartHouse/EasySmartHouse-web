...
import net.easysmarthouse.ui.webui.client.view.widget.WelcomeLabel;
import net.easysmarthouse.ui.i18n.Root;
import java.util.HashMap;
import java.util.Map;

import net.easysmarthouse.ui.webui.client.PanelManager;
import net.easysmarthouse.ui.webui.client.PanelManager.PanelKey;
import net.easysmarthouse.ui.webui.client.controller.RootController.RootControllerAction;
import net.easysmarthouse.ui.webui.client.history.HistoryChangeListener;
import net.easysmarthouse.ui.webui.client.messages.MessagesHolder;
import net.easysmarthouse.ui.webui.client.view.handler.LogoutHandler;
