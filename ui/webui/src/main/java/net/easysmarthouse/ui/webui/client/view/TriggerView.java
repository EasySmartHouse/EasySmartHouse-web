...
import net.easysmarthouse.ui.webui.client.view.handler.TriggerActivationHandler;
...
public class TriggerView extends GridTabView<TriggerModel> {
    ...
    private final net.easysmarthouse.ui.i18n.Trigger triggerMessages = MessagesHolder.getInstance().getTriggersMessages();
