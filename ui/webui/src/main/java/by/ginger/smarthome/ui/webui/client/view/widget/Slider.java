...
public class Slider extends Widget {
    ...
    private native void createSliderJS(Slider x, String id, JavaScriptObject options) /*-{
     ...
     x.@by.ginger.smarthome.ui.webui.client.view.widget.Slider::fireOnStartEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayNumber;)(event, ui.values);
     };
     options.slide = function(event, ui) {
     return x.@by.ginger.smarthome.ui.webui.client.view.widget.Slider::fireOnSlideEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayNumber;)(event, ui.values);
     };
     options.change = function(event, ui) {
     var has = event.originalEvent ? true : false;
     x.@by.ginger.smarthome.ui.webui.client.view.widget.Slider::fireOnChangeEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayNumber;Z)(event, ui.values, has);                
     };
     options.stop = function(event, ui) {
     x.@by.ginger.smarthome.ui.webui.client.view.widget.Slider::fireOnStopEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/core/client/JsArrayNumber;)(event, ui.values);
     };
